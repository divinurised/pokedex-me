...
function Map({ pokemonDetails }) {
  ...
  const pokemonMarker = new L.icon({
    iconUrl: 'https://cdn.picpng.com/pin/pin-pokemon-pokeball-map-seeker-54266.png',
    iconSize: [25, 41],
    iconAnchor: [10, 41],
    popupAnchor: [2, -40]
  });
  ...
  return (
    <>
      {loading ? (
        ...
        <MapContainer center={[current.latitude, current.longitude]} zoom={20} scrollWheelZoom={false}>
          <TileLayer
